...
const CSV_TEMPLATE = `sku,name,brand,category,price,pix_price,stock,description
CPU-001,Ryzen 5 7600,AMD,cpu,1499.00,1274.15,5,"Processador 6 núcleos AM5"
GPU-001,RTX 4060 8GB,Asus,gpu,2199.00,1869.15,3,"Placa de vídeo gaming"
`;

export function ImportarCSVButton() {
  ...
  const baixarTemplate = () => {
    ...
    a.href = url;
    a.download = "modelo-produtos-starteq.csv";
    a.click();
  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-2 bg-starteq-card border border-starteq-line hover:border-starteq-gold/40 text-starteq-bone font-display font-bold tracking-wide uppercase text-sm px-6 py-3 rounded-lg transition-all"
      >
          ...
          >
            <div className="flex items-center justify-between gap-3 px-5 py-4 border-b border-starteq-line">
              <h3 className="font-space font-bold text-starteq-bone inline-flex items-center gap-2">
                ...
                {step === "escolher" && "Importar produtos · CSV"}
              ...
              {step === "escolher" && (
                <>
                  <p className="text-sm text-starteq-text leading-relaxed mb-4">
                    Suba um <b className="text-starteq-bone">.csv</b> ou <b className="text-starteq-bone">.xlsx</b> com seus produtos. Aceita o export padrão do <b className="text-starteq-gold">GestãoClick</b>.
                  </p>
                  ...
                  <div className="mt-4 flex items-center justify-between gap-3 text-xs">
                    ...
                    <span className="text-starteq-muted">Colunas: sku · name · brand · category · price · pix_price · stock · description</span>
                  </div>
                </>
              )}
              ...
              {step === "preview" && (
                <>
                  ...
                  <p className="text-xs text-starteq-muted leading-relaxed mb-4">
                    Importação substitui produtos com mesmo <b>SKU</b> e cria os novos. Estoque atual é preservado em &quot;Movimentações&quot;.
                  </p>
              ...
              {step === "sucesso" && (
                <>
                  <div className="text-center py-4">
                    ...
                    <div className="font-space font-black text-starteq-bone text-xl mt-3">{rowCount} produtos importados</div>
                    <div className="text-sm text-starteq-muted mt-1">Site público e IA do Júnior já estão atualizados.</div>
                  </div>
                  <button
                    onClick={close}
