...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="bg-starteq-coal py-16 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-display text-3xl lg:text-4xl font-bold text-starteq-bone text-center mb-12">
            Por que a Starteq
          </h2>
          <div className="grid md:grid-cols-3 gap-6">
            <Differential
              ...
              text="Cada peça do montador é checada por software antes de você pagar. Não há erro de socket, de RAM, de wattagem."
            />
            <Differential
              icon="🛵"
            ...
            <Differential
              ...
              text="Tira dúvida no WhatsApp com IA treinada no nosso estoque · finaliza com gente real quando precisar."
            />
          </div>
        </div>
      </section>
